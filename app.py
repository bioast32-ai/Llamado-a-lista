...
# =========================================================
# DISEÑO Y ESTILOS PERSONALIZADOS (CSS)
# =========================================================
st.markdown("""
    <style>
...
# Procesamiento de la vista por fecha
...
with g1:
    st.markdown("**Estado general de puntualidad y asistencia**")
...
# Columnas idénticas al archivo Excel original
export_cols = ["Fecha", "ID", "Nombre", "Sector", "Llegada", "Salida", "Puntualidad", "Estado", "Marcaciones"]
st.dataframe(filtered[export_cols], hide_index=True)
...
with tab2:
    pending_df = view[view["Estado"] == "Sin marcación"][["ID", "Nombre", "Sector", "Puntualidad"]]
...
# Exportación exacta con los 9 campos solicitados
